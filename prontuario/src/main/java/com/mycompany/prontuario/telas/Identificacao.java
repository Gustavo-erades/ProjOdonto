...
public class Identificacao extends javax.swing.JFrame {
    ...
    public void resultadoPesquisaPaciente(String id) throws SQLException{
        ...
        rs[0]=preparedStatement1.executeQuery();
        Object[] colunas=new Object[]{"Endereco","Celular","Telefone Residencial","Profissao","Data de Nascimento"};
        DefaultTableModel modelo=new DefaultTableModel(colunas,0);
        while(rs[0].next()){
            Object[] pacientes=new Object[]{
...
*/
    ...
    private void initComponents() {
        ...
        resultPesquisa2.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Endereço", "Celular", "Telefone Residencial", "Profissão", "Data de nascimento"
            }
        ) {
        ...
        if (resultPesquisa1.getColumnModel().getColumnCount() > 0) {
            resultPesquisa1.getColumnModel().getColumn(5).setHeaderValue("Última Consulta");
        }
